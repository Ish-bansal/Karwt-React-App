        ...
        <div class="products">
          <div class="product">
            <div class="product-image">
              <div class="image"> <a href="detail.html"><img src={props.imgsrc} alt="" /></a> </div>
              {/* <!-- /.image --> */}
            ...
            <div class="product-info text-left">
              ...
              <div class="product-price"> <span class="price">{props.oprice} </span> <span class="price-before-discount">{props.dprice}</span> </div>
              {/* <!-- /.product-price --> */}
...
export default ScrolsTabsProduct
